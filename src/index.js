...
contract.methods.totalSupply().call((err, symbol) => {
  console.log("Symbol:", symbol);
});
contract.methods
  .balanceOf("0xa5886E14065DC57C6784dcd58d79223f5138C5F3")
  .call((err, tokens) => {
    console.log("Account Tokens:", web3.utils.fromWei(tokens, "ether"));
  });
